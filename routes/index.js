...
router.get('/', function(req, res, next) {
  ...
  category.exec(function(err, data){
    if(err) throw err
    res.render('index',{title:'Scoops Ice Cream Shop', categoryRecord:data ,loginUserInfo:loginUser, latestProduct: productData,userData:userdata})
  })
})
...
router.get('/about-us', function(req, res, next) {
  ...
  category.exec(function(err,data){
    res.render('client/aboutus',{title:'Scoops Ice Cream Shop',loginUserInfo:loginUser,categoryRecord:data,userData:userdata})
...
router.get('/action-button', function(req, res, next) {
    ...
    res.render('client/action_button',{title:'Scoops Ice Cream Shop',})
...
router.get('/Order/Completed', function(req, res, next) {
  ...
  category.exec(function(err,data){
    res.render('client/completedOreder',{title:'Scoops Ice Cream Shop',loginUserInfo:loginUser,categoryRecord:data,productRecord:productData,userData:userdata})
...
router.get('/adminHeader',checkLoginUser, function(req, res, next) {
  ...
  res.render('admin/adminHeader',{title:'Scoops Ice Cream Shop',loginUser:loginUser})
});
...
router.get('/header', function(req, res, next) {
 ...
 category.exec(function(err, data){
    if(err) throw err
    res.render('client/header',{title:'Scoops Ice Cream Shop', categoryRecord:data,loginUserInfo:loginUser,userData:userdata})
  })
});
...
router.get('/Brands/:name', function(req, res, next) {
  ...
  productModel.find({category:req.params.name}).sort({created_at: -1}).exec(function(err, data){
     if(err) throw err
     res.render('client/view-product',{title:'Scoops Ice Cream Shop',
      prodectRecord:data,
...
router.get('/footer', function(req,res, next){
  ...
  category.exec(function(err,data){
    res.render('client/footer',{title:'Scoops Ice Cream Shop',categoryRecord:data,loginUserInfo:loginUser,userData:userdata})
  })
})
...
router.get('/brands/:name', function(req,res, next){
  ...
  productModel.find({brand:req.params.name}).exec(function(err,data){
    res.render('client/view-product',{title:'Scoops Ice Cream Shop',productRecord:data,loginUserInfo:loginUser, userData:userdata})
  })
})
...
router.get('/follow', function(req,res, next){
  res.render('follow',{title:'Scoops Ice Cream Shop',})
})
...
router.get('/latestProduct', function(req,res, next){
  ...
  productModel.find({}).sort({created_at:-1}).limit(5).exec(function(err,data){
    if (err) throw err
    res.render('client/latestProduct',{title:'Scoops Ice Cream Shop', latestProduct: data,loginUserInfo:loginUser,userData:userdata})
  })
})
...
router.get('/view-category', function(req,res, next){
  ...
  category.exec(function(err, data){
    if(err) throw err
    console.log(data)
    res.render('client/view-category',{title:'Scoops Ice Cream Shop', categoryRecord:data,loginUserInfo:loginUser,userData:userdata})
  })
})
...
router.get('/productDetails/:id', function(req,res, next){
  ...
  productModel.find({_id:req.params.id}).exec(function(err,data){
    if (err) throw err
    res.render('client/productDetails',{title:'Scoops Ice Cream Shop',
    loginUserInfo:loginUser,
     prodectRecord: data,
      categoryRecord:categoryData,
      userData:userdata
...
router.get('/cart', function(req, res, next) {
  ...
  category.exec(function(err, data){
    ...
    if (!req.session.cart) {
    return res.render('client/cart', {title: 'Scoops Ice Cream Shop',categoryRecord: data, products: '',loginUserInfo:loginUser,userData:userdata});
  }

  var cart = new Cart(req.session.cart);
  console.log("CART ITEMS"+JSON.stringify(cart.getItems()))
  res.render('client/cart', {title: 'Scoops Ice Cream Shop',categoryRecord: data, products: cart.getItems(), totalPrice: cart.totalPrice,loginUserInfo:loginUser, userData:userdata});
});
})
})
...
router.get('/checkout',checkUser, function(req, res,next){
  ...
  userModel.find({_id:loginUser}).exec(function(err, data){
    if(err) throw err
    res.render('client/checkout',{title:'Scoops Ice Cream Shop',userRecord:data,products: cart.getItems(), categoryRecord:catRec,totalPrice: cart.totalPrice,loginUserInfo:loginUser, userData:userdata})
  })
})
...
category.exec(function(err, catdata){
  ...
  userModel.find({_id:req.params.id}).exec(function(err,data){
    if(err) throw err
    res.render('client/userProfile',{title:'Scoops Ice Cream Shop',userRecord:data,categoryRecord:catdata,loginUserInfo:loginUser,userData:userdata})
  })
})
...
router.get('/my-order',function(req,res,next){
  ...
  orderModel.find({user:loginUser}).populate('product').exec(function(err,data){
    ...
    res.render('client/userOrder',{title:'Scoops Ice Cream Shop',userOrder:data,categoryRecord:catdata,loginUserInfo:loginUser, userData:userdata})
  })
})
})
